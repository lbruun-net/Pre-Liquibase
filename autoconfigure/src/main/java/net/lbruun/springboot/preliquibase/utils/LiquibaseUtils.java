...
public class LiquibaseUtils {
   ...
   * <p>
   * The method invokes
   * {@code liquibase.database.DatabaseFactory#findCorrectDatabaseImplementation()} and therefore
   * requires Liquibase library on the classpath.
   *
   * <p>
   * The method works like this: The database is determined by connecting to it and retrieving
   ...
   *
   * <p>
   * Note that this is a fairly heavy operation as it involves a round-trip to the database. As the
   * information does not change it is best to use this method only once and then cache the result.
   *
