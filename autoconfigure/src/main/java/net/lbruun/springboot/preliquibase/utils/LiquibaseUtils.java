...
public class LiquibaseUtils {
  ...
  public static String getLiquibaseDatabaseShortName(DataSource dataSource) {
    ...
    try (final Connection connection = dataSource.getConnection();
      ...
      throw new ResolveDbPlatformError(
          "Error while finding Liquibase Database implementation for DataSource", e);
    } catch (final Exception e) {
      throw new ResolveDbPlatformError(
          "Unexpected error while finding Liquibase Database implementation for DataSource", e);
    }
  }
