...
public class PreLiquibaseAutoConfiguration {
  ...
  PreLiquibaseDataSourceProvider preLiquibaseDataSourceProvider(
    ...
    return new DefaultPreLiquibaseDataSourceProvider(liquibaseProperties, dataSourceProperties,
   ...
   */
  @Bean
  PreLiquibase preLiquibase(Environment environment, PreLiquibaseProperties properties,
   ...
   *
   * <p>
   * Note: The exact methodology which Spring Boot uses to determine which DataSource to use for
