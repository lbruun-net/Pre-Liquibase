...
image:https://github.com/lbruun/pre-liquibase/actions/workflows/main.yml/badge.svg[CI]
...
image:https://javadoc.io/badge2/net.lbruun.springboot/preliquibase-spring-boot-starter/javadoc.svg[javadoc,link="https://javadoc.io/doc/net.lbruun.springboot/preliquibase-spring-boot-starter"]
